...
- переписать докер-файл на [многоступенчатую сборку с экспортным слоем](../../lectures/lecture_2/lecture_1.md#17-многоступенчатая-сборка-образов), который представляет собой пустой образ с экспортом данных из образа предыдущего шага на хост ОС
