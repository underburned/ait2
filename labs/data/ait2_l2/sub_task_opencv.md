...
2. Применить выбранный алгоритм (алгоритмы) к изображениям, привести результаты обработки.
   [Пример изображения](images/IMG_1836_3840.png) (можно использовать любое другое).
